...
def game_over():
  ...
  sound_game_over = pygame.mixer.Sound("./assets/sound/game-over.wav")
...
def game():
  ...
  # fondo
  background = pygame.image.load("./assets/img/space.jpg")
  # titulo
  pygame.display.set_caption("Space Meteore")
  # sonido de fondo
  pygame.mixer.music.load("./assets/sound/game.wav")
  pygame.mixer.music.play(3)
  # sonidos colisiones
  sound_explotion_asteroid = pygame.mixer.Sound("./assets/sound/explosion-asteroid.wav")
  sound_explotion_spaceship = pygame.mixer.Sound("./assets/sound/explosion-spaceship.aiff")
